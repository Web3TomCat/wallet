...
export default class Btn extends Component {
  ...
  render () {
    const {  btnWidth, btnPress, btnText,btnMarginTop } = this.props
    return (
      <TouchableOpacity style={[{width: btnWidth ,marginTop: btnMarginTop,}, pubS.center, styles.btnView]} activeOpacity={.7} onPress={btnPress}>
